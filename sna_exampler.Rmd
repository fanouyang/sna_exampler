...
---
## An exampler of social network analysis with two different format
In this markdown, I show an example of how to use popular SNA packages (i.e., *sna* and *igraph*) to conduct SNA analysis. There are two data format, namely adjacency matrix and edgelist.
